    ...
    return (
        <>
            ...
            <SafeAreaView>
                ...
                />
                <TouchableOpacity onPress={() => navigation.navigate('Lumos 499')}>
                    <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', margin: 20 }}>
                        <Text style={{ fontSize: 20 }}>Please go to main Screen</Text>
                        <Ionicons name="md-arrow-forward" size={32} onPress={() => navigation.navigate('Lumos 499')} /></View>
                </TouchableOpacity>
            </SafeAreaView>
        </>
    );
